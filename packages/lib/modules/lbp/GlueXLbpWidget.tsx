  ...
  const widgetConfig = useMemo(() => {
    ...
    return {
      ...
      theme: {
        palette: {
          primary: {
            main: colors.accent.green, // Hyperwave accent green
            review: "#6300B9" // Hyperwave purple
          },
        background: {
          ...
          text: {
            primary: colors.accent.green, // Hyperwave accent green
            secondary: colors.gray[400] // Light gray for secondary text
          },
          divider: colors.accent.green // Hyperwave accent green
        }
      },
